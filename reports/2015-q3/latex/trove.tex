...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/active_core_scrtrove.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/scr_patchsets_iterationstrove.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/timewaiting4reviewer_mediantrove.csv}{}% use head of csv as column names
    {\\\labels & \mediantime & \meantime}
    \end{tabular}
\end{tabular}
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/timewaiting4submitter_mediantrove.csv}{}% use head of csv as column names
    {\\\labels & \mediantime & \meantime}
    \end{tabular}
\end{tabular}
