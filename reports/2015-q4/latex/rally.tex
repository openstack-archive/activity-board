...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/commitsRally.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/closedRally.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/submitted_reviewsRally.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/active_core_scrRally.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    \vspace{0pt} 
    \includegraphics[scale=.35]{figs/authorsRally.eps}
    & 
    \vspace{0pt}
    \begin{tabular}{l|l}%
    \bfseries Period & \bfseries Authors % specify table head
    \csvreader[head to column names]{data/authorsRally.csv}{}% use head of csv as column names
    {\\\labels & \authors}
    \end{tabular}
\end{tabular}
...
\begin{tabular}{l|l}%
    ...
    \csvreader[head to column names]{data/scm_top_authors_project_Rally.csv}{}% use head of csv as column names
...
\begin{tabular}{l|l}%
    ...
    \csvreader[head to column names]{data/scm_top_companies_project_Rally.csv}{}% use head of csv as column names
    {\\\hline\csvcoli&\csvcolii}% specify your coloumns here
\end{tabular}
\end {tabular}
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/bmiRally.csv}{}% use head of csv as column names
    {\\\labels & \bmi}
    \end{tabular}
\end{tabular}
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/timetoreview_medianRally.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/scr_patchsets_iterationsRally.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/timewaiting4reviewer_medianRally.csv}{}% use head of csv as column names
    {\\\labels & \mediantime & \meantime}
    \end{tabular}
\end{tabular}
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/timewaiting4submitter_medianRally.csv}{}% use head of csv as column names
    {\\\labels & \mediantime & \meantime}
    \end{tabular}
\end{tabular}
