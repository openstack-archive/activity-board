...
The October-December 2015 summary of OpenStack Community Activity
...
as IRC channels, mailing lists and questions/answers.} shows a
stable growth by the OpenStack Community. As new repositories and
teams keep being added, the projects keeps growing. On the other hand
it is worth mentioning the decrease in the activity for some quarters 
in project teams such as Nova or stable ones such as Horizon or
Cinder. This shows the maturity reached by the some of the project
teams in the OpenStack Foundation.

\subsection*{Key findings:}
\begin{description}

\item[Active Core Reviewers reach a new peak] \hfill \\
Although Git activity does not show that big increase of activity
if compared to Gerrit, the development effort in the project keeps
increasing. This last quarter of 2015 the number of Active Core 
Reviewers reached a new record of 449 different developers.


\item[Time to merge keeps decreasing] \hfill \\
During the third quarter of 2015 a small increase in the time to merge trend
may mean a change in the trend. However, this last quarter of 2015 keeps 
the previous tendency. During this period the median time to merge a changeset
into master decreased from 2.91 days down to 2.38 days.

\item[Efficiency closing tickets decreases] \hfill \\
It is noticeable the decrease when closing tickets within the OpenStack Community.
Previous quarters reached 60\% of closing tickets while this quarter shows
a 44\% of closing ones. This could be seen as a poor performance indicator of 
the project teams. However, if this metric is calculated in terms of efficiency
closing changesets in the review system, it keeps stable in around 80\%.
...
the fourth quarter of 2015, comparing it to previous eight
...
The overall activity keeps increasing. Specifically in the case of Gerrit, Launchpad tickets
and Askbot activity. 
...
In this fourth quarter of 2015 the mean number of developers active per
month has reached a total of 758. As similarly seen in the second quarter of
2015, these two quarters show a lower number of developer per month
than in the release quarters.
...
contributors.}) follows a similar patter. 
