...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/commitsOpenStackAnsible.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/closedOpenStackAnsible.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/submitted_reviewsOpenStackAnsible.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/active_core_scrOpenStackAnsible.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/authorsOpenStackAnsible.csv}{}% use head of csv as column names
    {\\\labels & \authors}
    \end{tabular}
\end{tabular}
...
\begin{tabular}{l|l}%
    ...
    \csvreader[head to column names]{data/scm_top_authors_project_OpenStackAnsible.csv}{}% use head of csv as column names
...
\begin{tabular}{l|l}%
    ...
    \csvreader[head to column names]{data/scm_top_companies_project_OpenStackAnsible.csv}{}% use head of csv as column names
    {\\\hline\csvcoli&\csvcolii}% specify your coloumns here
\end{tabular}
\end {tabular}
...
\begin{tabular}{p{7cm} p{5cm}}
    \vspace{0pt} 
    \includegraphics[scale=.35]{figs/bmiOpenStackAnsible.eps}
    & 
    \vspace{0pt}
    \begin{tabular}{l|l}%
    \bfseries Period & \bfseries Closed/Opened % specify table head
    \csvreader[head to column names]{data/bmiOpenStackAnsible.csv}{}% use head of csv as column names
    {\\\labels & \bmi}
    \end{tabular}
\end{tabular}
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \csvreader[head to column names]{data/timetoreview_medianOpenStackAnsible.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/scr_patchsets_iterationsOpenStackAnsible.csv}{}% use head of csv as column names
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/timewaiting4reviewer_medianOpenStackAnsible.csv}{}% use head of csv as column names
    {\\\labels & \mediantime & \meantime}
    \end{tabular}
\end{tabular}
...
\begin{tabular}{p{7cm} p{5cm}}
    ...
    \begin{tabular}{l|r|r|}%
    \bfseries Period & \bfseries Median & \bfseries Mean % specify table head
    \csvreader[head to column names]{data/timewaiting4submitter_medianOpenStackAnsible.csv}{}% use head of csv as column names
    {\\\labels & \mediantime & \meantime}
    \end{tabular}
\end{tabular}
